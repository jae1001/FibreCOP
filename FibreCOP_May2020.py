...
Code developed by Dr. Adarsh Kaniyoor,
...
def calcCOP():
    ...
    for i in range(0,count):
        ...
        print('The baseline value of smoothed and filtered ODFs are',min(ySmooth),'and',min(yFilter),'\n')
...
label17=tk.Label(window, text="(Image: use < 1, sector angle for radial sum; Data: NA)")
